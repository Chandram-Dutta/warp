...
use crate::terminal::view::init_project::{
    ...
    LINKABLE_FILES, ProjectScopedRulesResult,
};
...
pub enum InitStepData {
    CodebaseContext { pwd_path: PathBuf },
    ProjectScopedRules { linkable_files: Vec<PathBuf> },
    CreateEnvironment,
}
...
impl InitProjectModel {
    ...
    pub fn new(pwd_path: PathBuf, ctx: &mut ModelContext<Self>) -> Self {
